...
const Card = ({user})=> {
  ...
  return (
    <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("ViewUser",{user})} >
      <Image source={{uri:user.image}} style={{width:40, height:40 , borderRadius:80, backgroundColor:"white", marginLeft: 7}} />
      ...
      <View style={{marginLeft:10, flexDirection:"row",   width:120, justifyContent:"space-around"}} >
        <TouchableOpacity onPress={() => {navigation.navigate("UpdateUser", {item:user})}}  style={{backgroundColor:"white", justifyContent:"center", alignItems:"center", borderRadius:50, width:50, height:50,}}>
            <Image style={{width:25, height:25}} source={require('../../assets//Images/update.png')}/>
        </TouchableOpacity>
        <TouchableOpacity style={{backgroundColor:"white", justifyContent:"center", alignItems:"center", borderRadius:50, width:50, height:50,}} onPress={() => deleteuser(user.id)}>
          <Image style={{width:25, height:25}}  source={require('../../assets//Images/rem.png')} />
        </TouchableOpacity>
      </View>
    </TouchableOpacity>
   );
